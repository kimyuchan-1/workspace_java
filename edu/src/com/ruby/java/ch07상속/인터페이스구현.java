...
interface Employee3 {
	void work(); // 추상 메소드와 유사

	void attendMeeting(); // 추상 메소드와 유사
}

class Manager2 implements Employee3 { // 추상 클래스의 extends = 인터페이스의 implements
	@Override
	public void work() {
...
public class 인터페이스구현 {
	public static void main(String[] args) {
		...
		manager.work(); // 호출하는 메소드가 모두 같음: 인터페이스
